...
| `source-command-sdd-onboard` | Guided SDD walkthrough — onboard a user through the full SDD cycle using their real codebase | user | `C:\Users\diego\.agents\skills\source-command-sdd-onboard\SKILL.md` |
| `teach` | Usa esta skill cualquier vez que expliques o enseñes algo a Diego, para que quede realmente entendido, no solo memorizado — incluso una explicación rápida. Basada en dos principios pedagógicos que Diego ha verificado personalmente durante años que funcionan. | project | `C:\Users\diego\Desktop\AI Learning\ai-tutor\.claude\skills\teach\SKILL.md` |
